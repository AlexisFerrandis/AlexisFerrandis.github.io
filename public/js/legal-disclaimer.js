...
if (localStorage.getItem("legalDisclaimerAgreement") == "true") {
    ...
    <div class="legal-disclaimer">
        <div class="legal-disclaimer__container">
            <img src="./public/assets/pictos-logos/logos/lrdb-primary.svg" alt="Logo du Repaire de Bacchus" />
			...
			<div id="flag"><img src="./public/assets/flags/fr.svg" alt="flag"/></div>
            ...
            <div class="legal-disclaimer__container--choices">
                <button id="legalDisclaimerAgree" type="button" class="button disclaimer-btn">oui</button>
                <button id="legalDisclaimerDisagree" type="button" class="button disclaimer-btn">non</button>
            </div>
        </div>
    </div>
    `;
	...
	countrySelection.addEventListener("change", () => {
		switch (countrySelection.value) {
			case "french":
				countryFlag.innerHTML = `<img src="./public/assets/flags/fr.svg" alt="flag"/>`;
				...
				break;
			case "english":
				countryFlag.innerHTML = `<img src="./public/assets/flags/gb.svg" alt="flag"/>`;
				...
				break;
			case "deutsch":
				countryFlag.innerHTML = `<img src="./public/assets/flags/de.svg" alt="flag"/>`;
				...
				break;
			case "italiano":
				countryFlag.innerHTML = `<img src="./public/assets/flags/it.svg" alt="flag"/>`;
				...
				break;
			case "español":
				countryFlag.innerHTML = `<img src="./public/assets/flags/es.svg" alt="flag"/>`;
				...
				break;
			case "русский":
				countryFlag.innerHTML = `<img src="./public/assets/flags/ru.svg" alt="flag"/>`;
				...
				break;
			case "中国人":
				countryFlag.innerHTML = `<img src="./public/assets/flags/cn.svg" alt="flag"/>`;
